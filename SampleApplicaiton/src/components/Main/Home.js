...
const AddTaskModal_1 = require("./AddTaskModal");
    ...
    render() {
        return (React.createElement(react_bootstrap_1.Container, { className: "p-5" },
            ...
            React.createElement(react_bootstrap_1.Row, { className: "pb-1" },
                React.createElement(react_bootstrap_1.Col, null,
                    React.createElement(react_bootstrap_1.Button, { variant: "primary", onClick: this.openAddModal }, "Add a New Task"))),
            React.createElement(DisplayTasks_1.default, null),
            React.createElement(AddTaskModal_1.default, { show: this.state.showAddModal, onHide: this.closeAddModal, reload: this.reloadPage })));
    }
}
